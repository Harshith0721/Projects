...
<title>Cloud View All Images Attackers</title>
...
<div id="wrapper">
	...
	<div id="page-bgbtm">
		<div id="content">
			<div class="post">
				<h2 align="center" class="heading">View all Image Attacked Count Chart Results..</h2>
	            <iframe src="Results1.jsp" height="400" width="500"></iframe>
		        <div align="center" class="subtitle">( Number of Times Attacked on files )</div>
